...
class HelperController extends Controller
{
    ...
    {
        $this->vdotCode = "M";
        // (X * 2 * 0.000104) / (-0.182258 + SQRT(0.182258 ^ 2 - 4 * 0.000104 * (-4.6 - 0.78 * Y)));
        $this->TARGET = (/* $this->DIST */1000 * 2 * 0.000104)
            / (-0.182258
                +
                sqrt(
                    (0.182258 * 0.182258) - 4 * 0.000104 * (-4.6 - 0.78 * $this->vDOT)
                ));
    }
    ...
    public function calculateForI5KvDot()
    {
        ...
        // (X * 2 * 0.000104) / (-0.182258 + SQRT(0.182258 ^ 2 - 4 * 0.000104 * (-4.6 - 0.86 * Y)));
        $this->TARGET = (/* $this->DIST */1000 * 2 * 0.000104)
            / (-0.182258
                +
                sqrt(
                    (0.182258 * 0.182258) - 4 * 0.000104 * (-4.6 - 0.86 * $this->vDOT)
                ));
    }
