...
class CustomCommonLibraryDetailController extends Controller
{
    ...
    public function show($id)
    {
         ...
         */
        if (!!!isset($customCommonLibrariesDetails->repetition_max)) {
    ...
    public function createUpdateCustomCommonLibraryDetails(Request $request)
    {
        ...
        if (isset($input['libraries_id'])) {
            ...
            if (isset($input['exercise_link'])) {
                $this->libraryRepository->updateRich([
                    'exercise_link' => $input['exercise_link'] ? $input['exercise_link'] : '',
                ], $input['libraries_id']);
            }
