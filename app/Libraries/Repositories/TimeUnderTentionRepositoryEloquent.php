...
class TimeUnderTentionRepositoryEloquent extends BaseRepository implements UsersRepository
{
    ...
    protected function commonFilterFn(&$value, $input)
    {
        ...
        if (isset($input['time_under_tention_id'])) {
            $value = $value->where('time_under_tention_id', $input['time_under_tention_id']);
        }
