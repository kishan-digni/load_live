...
/**
 * Class EquipmentsRepositoryEloquent.
 *
 * @package namespace App\Libraries\Repositories;
 */
class EquipmentsRepositoryEloquent extends BaseRepository implements UsersRepository
{
    ...
    public function getDetails($input = null)
    {
        ...
        $query = $this->getCommonPaginationFilterFn($value, $input);
        dd($query);
        return [
            'count' => $count,
            'list' => $value
