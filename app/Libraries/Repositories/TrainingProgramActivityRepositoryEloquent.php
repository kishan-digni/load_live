...
use App\Models\TrainingProgramActivity;
...
/**
 * Class TrainingProgramActivityRepositoryEloquent.
 *
 * @package namespace App\Libraries\Repositories;
 */
class TrainingProgramActivityRepositoryEloquent extends BaseRepository implements UsersRepository
{
    ...
    {
        return TrainingProgramActivity::class;
    }
